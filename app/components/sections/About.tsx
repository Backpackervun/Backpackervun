      ...
      <div className="container">
        <div className="about-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.8 }}>
            ...
            {[
              "From Indonesia — a passionate traveler with a deep love for discovering new cultures, people, and places. I have explored 15+ countries across Asia, the Middle East, and Europe, gaining first-hand insight into diverse traditions, lifestyles, and travel experiences.",
              "I have led group trips of all sizes — from intimate private groups to 58+ corporate participants, and coordinated 4 rounds of Umrah pilgrimages with up to 36 participants each round. I have also guided dedicated Japan tours (13 participants) and multi-country Southeast Asia trips, bringing my total to over 300 travelers guided.",
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: "1rem", paddingTop: "1.5rem", borderTop: "1px solid var(--border)" }} className="stats-grid">
              {stats.map(s => (
                <div key={s.label}>
                  <p style={{ fontFamily: "var(--f)", fontSize: s.value === "BNSP" ? "1.25rem" : "1.5rem", color: "var(--gold)", fontWeight: 900, lineHeight: 1, letterSpacing: "-0.02em" }}>{s.value}</p>
            ...
            <div style={{ marginTop: "1.5rem", display: "flex", gap: "1.5rem", flexWrap: "wrap" }}>
              ...
              <span style={{ color: "var(--text-faint)", fontFamily: "var(--f)" }}>·</span>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9, delay: 0.1 }}
            ...
            <div style={{ position: "relative", overflow: "hidden", aspectRatio: "1/1" }}>
              <Image src="/ervan-sq.jpg" alt="Ervan A. Anggakusuma" fill
            ...
            <div style={{ position: "absolute", bottom: "-1rem", left: "-1.25rem", padding: "0.9rem 1.2rem", background: "var(--bg)", border: "1px solid var(--border)" }}>
              <p style={{ fontFamily: "var(--f)", fontSize: "0.72rem", fontWeight: 700, color: "var(--text)", lineHeight: 1.4 }}>Ervan A. Anggakusuma</p>
