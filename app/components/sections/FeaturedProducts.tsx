...
const products = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?w=800&q=80&auto=format&fit=crop",
    price: "$15",
    cta: "Get Pack",
  },
];
        ...
        >
          <div>
            ...
            >
              Tools for the
              <br />
              <em>deliberate traveler.</em>
            </h2>
          </div>
          <a
            href="#"
            className="text-xs tracking-widest uppercase self-start lg:self-auto inline-flex items-center gap-2"
    ...
    >
      ...
      <div className="relative h-52 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent 50%, var(--color-surface-2) 100%)",
          }}
        />
        {/* Tag */}
      ...
      <div className="flex flex-col flex-1 p-6">
        ...
        <div className="flex items-center justify-between pt-5"
          ...
          <a
            href="#"
            className="text-xs tracking-widest uppercase px-4 py-2.5 transition-all duration-300 border"
            style={{
