    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(10,10,10,0.35) 0%, rgba(10,10,10,0.2) 40%, rgba(10,10,10,0.65) 80%, rgba(10,10,10,1) 100%)",
          }}
        />
        {/* Film grain */}
        <div
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-5xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-[clamp(2.8rem,9vw,8rem)] leading-none tracking-tight mb-6 select-none font-bold uppercase"
          style={{
        ...
        <motion.p
          ...
          className="text-base lg:text-lg font-light mb-3 max-w-xl"
          style={{ color: "rgba(240,236,228,0.7)", fontFamily: "var(--font-body)", fontWeight: 300 }}
        >
