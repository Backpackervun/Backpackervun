...
const services = [
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&q=90&auto=format&fit=crop",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=800&q=90&auto=format&fit=crop",
  ...
  return (
    <section id="services" ref={ref} className="section" style={{ background: "var(--bg)" }}>
      ...
      <div className="container">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }} style={{ marginBottom: "3rem" }}>
...
function SvcCard({ s, index, inView, tall }: { s: typeof services[0]; index: number; inView: boolean; tall?: boolean }) {
  return (
    <motion.div className="card-wrap"
      ...
      <div style={{ position: "relative", height: tall ? "240px" : "200px", overflow: "hidden" }}>
        <div className="card-img" style={{ position: "absolute", inset: 0, backgroundImage: `url('${s.img}')`, backgroundSize: "cover", backgroundPosition: "center", filter: "saturate(0.6) brightness(0.55)" }} />
